		...
		<div class="col-xs-12 col-sm-10 col-md-10 col-lg-11 col-nav">
			...
			<ul class="user-mini-nav">
				...
				<?php else : ?>
					...
					$newlinks = l(t('Sign in / Register'), '/user', array('query' => array('destination' => $path_alias), 'attributes' => array('title' => t('Sign in / Register'))));
					?>
					<li><a  href="/user"><?php print $newlinks; ?></a></li>
